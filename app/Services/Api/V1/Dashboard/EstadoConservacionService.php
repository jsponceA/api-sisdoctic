...
class EstadoConservacionService
{
    public function queryListado(array $params = [])
    {
        ...
        return EstadoConservacion::query()
    ...
    public function guardar(array $data)
    {
        ...
        $estadoConservacion->fill($data->toArray());
    ...
    {
        return EstadoConservacion::query()->findOrFail($id);
    }

    public function modificar(int | string $id,array $data)
    {
        $data = collect($data);
        $estadoConservacion = EstadoConservacion::query()->findOrFail($id);
        $estadoConservacion->fill($data->toArray());
    ...
    {
        $estadoConservacion = EstadoConservacion::query()->findOrFail($id);
        $estadoConservacion->eliminado_por_usuario_id = $userId;
        $estadoConservacion->update();
